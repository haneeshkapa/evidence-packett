...
const ARTIFACTS: Artifact[] = [
  {
    ...
    actions: '• **Inventing TextAI.bot**: Engineered a hybrid cloud/on-device agent (Node/Tasker/Claude) that intercepts SMS, performs RAG on Shopify/Sheets, and generates context-aware replies.\n• **Full-Stack Timesheets**: Built a secure web portal (React/TS/SQLite/Prisma) with JWT auth and RBAC, replacing paper logs with real-time dashboards.\n• **DevOps & Reliability**: Established CI/CD pipelines (Render/Vercel) with **automated reliability checks** and structured logging to bring enterprise discipline to the factory floor.\n• **System Integration**: Orchestrated **end-to-end testing** of React, Tailwind, Node.js, and Google/Shopify APIs, ensuring secure and scalable data flow via Cloudflare DNS.',
  ...
  },
  {
    ...
    actions: '• **Curriculum Engineering**: I rebuilt the state-provided syllabus into modular, visual-first "micro-lessons" based on **live usability testing with seniors**, focusing on high-utility tasks (Telehealth, Gmail, Zoom).\n• **Hyper-Localized Delivery**: Conducted 10-week intensive cohorts at community hubs (Coalition for a Better Acre), translating technical concepts into culturally relevant analogies in real-time.\n• **Hardware Ops**: Orchestrated the procurement, configuration, security patching, and **quality assurance** of 500+ Chromebooks, ensuring devices were "unbrickable" for novice users.',
